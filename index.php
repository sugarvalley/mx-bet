...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark border-white mb-3">
    <a class="navbar-brand" href="#">MX BET</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a role="button" href="#" class="btn btn-outline-primary" id="btn-log">Logowanie</a>
